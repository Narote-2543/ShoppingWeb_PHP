<?php
    ...
    $sql = "SELECT * FROM db_member where Flgstatus = 'A'";
...
<head>
    ...
    <script>
        function chkedit(idmember){
            var popup = window.open("editmember.php?idmember="+idmember, "จัดการสมาชิก", "width=600,height=300");
        }
        function chkdel(idmember){
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div>
                        <table width="100%">
                            <thead align="center">
                                <tr style="background-color:C8FFE1;">
                                    <td><b/>ลำดับ</td>
                                    <td><b/>รหัสสมาชิก</td>
                                    <td><b/>ชื่อนามสกุล</td>
                                    <td><b/>ที่อยู่</td>
                                ...
                                ?>
                                        <tr style="background-color:C8E3FF;">
                                            ...
                                            <td align="center"  width="10%">
                                                <button type="button" class="btn btn-Warning" onclick="chkedit(<?php echo $row['idmember']?>)">
                                            ...
                                            <td align="center"  width="10%">
                                                <button type="button" class="btn btn-Danger" onclick="chkdel(<?php echo $row['idmember']?>)">
                            ...
                            <tr align="center">
                                <td colspan="8">
                                    <button type="button" class="btn btn-Info" onclick="openpopup()">เพิ่มข้อมูล</button>
                                </td>
                            </tr>
                        </table>
                    </div>
